...
class EndOrderT: UIViewController {
...
extension EndOrderT : UITableViewDelegate , UITableViewDataSource {
...
extension EndOrderT : UIPickerViewDelegate, UIPickerViewDataSource {
