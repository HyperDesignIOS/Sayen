...
public class Configuration {
    ...
    struct Merchant {
        static let identifier =  "merchant.User.Sayen"
        //com.example.apple-samplecode.Offering-Apple-Pay-in-Your-App
//        "merchant.\(MainBundle.prefix).Offering-Apple-Pay-in-Your-App"
    }
}
