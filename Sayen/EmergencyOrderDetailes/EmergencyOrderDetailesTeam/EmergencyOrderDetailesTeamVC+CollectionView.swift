//
//  EmergencyOrderDetailesTeamVC+CollectionVie.swift
//  Sayen  Worker
//
...
extension EmergencyOrderDetailesTeamVC : UICollectionViewDelegate , UICollectionViewDataSource  , UICollectionViewDelegateFlowLayout , RemoveImagePro{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        } else if !finishedImagesStr.isEmpty {
            count = finishedImagesStr.count
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if !selectedImages.isEmpty {
            ...
            if let url = URL(string: finishedImagesStr[indexPath.row]) {
